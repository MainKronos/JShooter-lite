...
export class Collide2D{
	...
	collideRectRectVector(p1, sz, p2, sz2){
	...
	collideRectCircleVector(r, sz, c, diameter){
	...
	collideCircleCircleVector(p1,d, p2, d2){
	...
	collidePointCircleVector(p, c, d){
	...
	collidePointEllipseVector(p, c, d){
	...
	collidePointRectVector(point, p1, sz){
	...
	collidePointLineVector(point,p1,p2, buffer){
	...
	collideLineCircleVector( p1,  p2,  c,  diameter){
	...
	collideLineLineVector(p1, p2, p3, p4, calcIntersection){
	...
	collideLineRectVector(p1, p2, r, rsz, calcIntersection){
	...
	collidePointPolyVector(p1, vertices){
	...
	collideCirclePolyVector(c, diameter, vertices, interior){
	...
	collideRectPolyVector(r, rsz, vertices, interior){
	...
	collideLinePolyVector(p1, p2, vertice){
	...
	collidePolyPolyVector(p1, p2, interior) {
	...
	collidePointTriangleVectorfunction(p, p1, p2, p3){
	...
	collidePointPointVector(p1, p2, buffer){
	...
	collidePointArcVector(p1, a, arcRadius, arcHeading, arcAngle, buffer){
		return p5.prototype.collidePointArc(p1.x, p1.y, a.x, a.y, arcRadius, arcHeading, arcAngle, buffer);
	}
}

export const C2D = new Collide2D();